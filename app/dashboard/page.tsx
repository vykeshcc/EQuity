...
export const metadata: Metadata = {
  title: "Dashboard — Sequence Peptide Evidence",
  description: "Live peptide research dashboard: study counts, quality scores, latest extractions, and regulatory pulse.",
};
